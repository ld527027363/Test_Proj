...
*/
PProtocol_ST Protocol_Link485_Initialize(__linksend send,__linkrecv recv,__linkfree free)
{
    if (!this)
    {
        ...
        this->login        = Protocol_Link485_Login;
        this->syncbatch    = Protocol_Link485_SyncBatch;
        this->heartpack    = Protocol_Link485_HeartPack;
        this->upgrade      = Protocol_Link485_Upgrade;
        this->puttag       = Protocol_Link485_PutTag;
        this->gettag       = Protocol_Link485_GetTag;
        this->setparam     = Protocol_Link485_SetParam;
        this->getparam     = Protocol_Link485_GetParam;
        this->clear        = Protocol_Link485_Clear;
        this->resend       = Protocol_Link485_Resend;
        this->sequence_inc = Protocol_Link485_Sequence_Inc;
        this->getresponse  = Protocol_Link485_GetResponse;

        this->ParamList = malloc(PP_MAX * sizeof(char*));
        memset(this->ParamList,0,PP_MAX * sizeof(char*));

        this->layers = malloc(5 * sizeof(Protocol_Layer_ST));
        memset(this->layers,0,sizeof(5 * sizeof(Protocol_Layer_ST)));
        ...
        this->layers[4] = Protocol_485_Initialize();


        this->layers[0]->down = this->layers[1];
        this->layers[1]->down = this->layers[2];
        this->layers[2]->down = this->layers[3];
        this->layers[3]->down = this->layers[4];

        this->layers[4]->up = this->layers[3];
        ...
        this->layers[4]->linksend = send;
        this->layers[4]->linkrecv = recv;
        this->layers[4]->linkfree = free;

        this->layers[0]->protocol = this;
        this->layers[1]->protocol = this;
        this->layers[2]->protocol = this;
        this->layers[3]->protocol = this;
        this->layers[4]->protocol = this;
